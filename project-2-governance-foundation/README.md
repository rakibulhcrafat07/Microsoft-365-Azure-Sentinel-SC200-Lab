...
**◀ Previous: [Project 1 — Environment Setup & Cross-Tenant Recovery](../project-1-environment-setup/README.md)**
...
![Organization information — tenant ID, technical contact](./images/01-org-profile-info.png)
...
![User basics filled in](./images/02-user1-basics.png)

**License assignment** — Business Premium:

![Business Premium license selected](./images/03-user1-license.png)
...
![Department set to IT](./images/04-user1-department-it.png)

**Review before finishing:**

![Review and finish screen](./images/05-user1-review.png)

**Confirmed:**

![Md. Imran Ahmed added to active users](./images/06-user1-confirmation.png)
...
![Wardha Anjum review screen — Department: Tech Support](./images/07-user2-review-wardha.png)
...
![Users list — Pallob unlicensed](./images/08-users-list-before-license.png)

**After:** license assigned, full roster licensed and ready:

![Users list — all five users licensed](./images/09-users-list-after-license.png)
...
![Security group basics — IT-Support-Team](./images/10-security-group-basics.png)

![IT-Support-Team group created confirmation](./images/11-security-group-created.png)

**Verified final state** — one owner, two members:

![Security group owners and members confirmed](./images/12-security-group-members.png)
...
![Microsoft 365 group basics — Managing-Team](./images/13-m365-group-basics.png)

**Members added:**

![Members added — Shakhawat, Wardha](./images/14-m365-group-members.png)

**Settings** — Privacy set to Private, and critically, **"Create a team for this group"** checked:

![Group settings — Create a Team for this group checked](./images/15-m365-group-settings-createteam.png)
...
![Managing-Team in group list with Teams icon](./images/16-m365-group-final-list.png)
...
![Dynamic-IT-Department showing 0 owners, 0 members](./images/17-dynamic-group-empty-problem.png)
...
![Membership type dropdown showing Dynamic User option](./images/18-entra-membership-type-dropdown.png)
...
![Dynamic membership rule builder with syntax generated](./images/19-dynamic-rule-syntax.png)

Saved successfully, with Membership type now correctly showing **Dynamic User**:

![Group saved with Dynamic User membership type](./images/20-dynamic-group-saved.png)

### Verification

Within a few minutes, **Md. Imran Ahmed** (the only user with `department = IT`) was automatically added — no manual action taken:

![Entra ID showing Imran Ahmed auto-added as the sole matching member](./images/21-entra-member-auto-added.png)
...
![M365 admin center showing member count but not yet synced](./images/22-m365-admin-syncing-delay.png)
...
![Management groups showing Tenant Root Group and subscription](./images/23-azure-management-groups.png)

**Reviewed the subscription** — confirmed correct tenant (`BOL`), Owner role, $200 credit available, $0 spent so far:

![Subscription overview — directory, role, credit, cost](./images/24-azure-subscription-overview.png)
...
![Resource group list showing new RG-Phase1-Lab](./images/25-resource-group-created.png)

**Applied tags** for cost tracking and organization before any resources were added to it:

![Resource group Tags page — environment: lab, owner: rakibul](./images/26-resource-group-tags.png)
...
**Next:** [Project 3 — Identity Security](../ROADMAP.md#project-3--identity-security-mfa-conditional-access)
